        ...
        var t = (function (e) {
            ...
            return (
              Object(a.useEffect)(
                function () {
                  f.a
                    .post("https://spotify-only-server-side-to-be-deployed.vercel.app/login", { code: e })
                    .then(function (e) {
                ...
                function () {
                  if (o && j) {
                    var e = setInterval(function () {
                      f.a
                        .post("https://spotify-only-server-side-to-be-deployed.vercel.app/refresh", {
                          refreshToken: o,
                        })
                        .then(function (e) {
        ...
        return (
          Object(a.useEffect)(
            function () {
              y &&
                f.a
                  .get("https://spotify-only-server-side-to-be-deployed.vercel.app/lyrics", {
...
//# sourceMappingURL=main.387788a7.chunk.js.map
